...
**Estado:** Producto usable (bus + Hermes + TTS Piper + app Tauri + HUD reimplementado). Howdy / HA / memoria local / phrase-map / stats están en el cerebro. Globo, visión, vigilancia y mem0 OSS **aún no**.  
**Fecha:** 2026-09-04  
